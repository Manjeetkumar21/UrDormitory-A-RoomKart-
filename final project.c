...
int n;
    ...
    {
        system("cls");
        printf("RELATED SEARCH RESULTS FOR BAIR MAJRA\n");
        category();
        scanf("%d", &n);
        switch (n)
        {
        ...
        FILE *p;
            char a;
            p = fopen("Bairmajraboyshostel.txt", "r");
            while (fscanf(p, "%c", &a) != EOF)
                printf("%c", a);
        ...
        case 2:
        {
        	FILE *p;
            char a;
            p = fopen("Bairmajragirlshostel.txt", "r");
            while (fscanf(p, "%c", &a) != EOF)
                printf("%c", a);
        ...
        case 5:
        {
        	FILE *p;
            char a;
            p = fopen("Bairmajraboysroom.txt", "r");
            while (fscanf(p, "%c", &a) != EOF)
                printf("%c", a);
        ...
        case 6:
        {
        		FILE *p;
            char a;
            p = fopen("Bairmajragirlsroom.txt", "r");
            while (fscanf(p, "%c", &a) != EOF)
                printf("%c", a);
